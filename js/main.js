              ...
              <h1 id="Main-Header">JavaScript Vault</h1>
                ...
                <div class="GuessCode">
                    ...
                    <div class="vault-buttons">
                        <button onclick="${elem_id}.buttonPress(this)" value="1" class="button1">1</button>
                        <button onclick="${elem_id}.buttonPress(this)" value="2" class="button2">2</button>
                        <button onclick="${elem_id}.buttonPress(this)" value="3" class="button3">3</button>
                    </div>
